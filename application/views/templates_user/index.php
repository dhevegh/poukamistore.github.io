    ...
    <section class="hero-slider">
        <div class="hero-items owl-carousel">
            <div class="single-slider-item set-bg" data-setbg="<?php echo base_url('assets/assets/');?>img/slider-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2019</h1>
            ...
            <div class="single-slider-item set-bg" data-setbg="<?php echo base_url('assets/assets/');?>img/slider-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2019</h1>
            ...
            <div class="single-slider-item set-bg" data-setbg="<?php echo base_url('assets/assets/');?>img/slider-3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2019</h1>
            ...
            <div class="row" id="product-list">
                <div class="col-lg-3 col-sm-6 mix all dresses bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="<?php echo base_url('assets/assets/');?>img/products/img-1.jpg" alt=""></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="lookbok-pic">
                        <img src="<?php echo base_url('assets/assets/');?>img/lookbok.jpg" alt="">
    ...
    <div class="logo-section spad">
        <div class="logo-items owl-carousel">
            <div class="logo-item">
                <img src="<?php echo base_url('assets/assets/');?>img/logos/logo-1.png" alt="">
            </div>
            <div class="logo-item">
                <img src="<?php echo base_url('assets/assets/');?>img/logos/logo-2.png" alt="">
            </div>
            <div class="logo-item">
                <img src="<?php echo base_url('assets/assets/');?>img/logos/logo-3.png" alt="">
            </div>
            <div class="logo-item">
                <img src="<?php echo base_url('assets/assets/');?>img/logos/logo-4.png" alt="">
            </div>
            <div class="logo-item">
                <img src="<?php echo base_url('assets/assets/');?>img/logos/logo-5.png" alt="">
            </div>
        </div>
    </div>